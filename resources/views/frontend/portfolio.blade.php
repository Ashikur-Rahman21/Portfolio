            ...
            <div class="col-md-12">
                ...
                <div class="filter-items">
                    ...
                    <div class="filter-item web_development">
                        <div class="inner">
                            <div class="photo"><a href="portfolio-detail.html"><img src="{{ asset('asset/images/development_1.jpg') }}" alt=""></a></div>
                            <div class="text">
                    ...
                    <div class="filter-item web_design">
                        <div class="inner">
                            <div class="photo"><a href="portfolio-detail.html"><img src="{{ asset('asset/images/design_3.jpg')}}" alt=""></a></div>
                            <div class="text">
                    ...
                    <div class="filter-item web_development">
                        <div class="inner">
                            <div class="photo"><a href="portfolio-detail.html"><img src="{{ asset('asset/images/development_3.jpg')}}" alt=""></a></div>
                            <div class="text">
                    ...
                    <div class="filter-item digital_marketing">
                        <div class="inner">
                            <div class="photo"><a href="portfolio-detail.html"><img src="{{ asset('asset/images/marketing_3.jpg')}}" alt=""></a></div>
                            <div class="text">
